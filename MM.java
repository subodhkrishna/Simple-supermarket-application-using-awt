...
public class MM extends Dialog implements ItemListener,ActionListener
{
	...
	public void addComp1(Component cc,int r,int c,int w,int h)
	{
		gc.gridx=c;
		gc.gridy=r;
		gc.gridwidth=w;
